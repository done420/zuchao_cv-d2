...
if __name__=="__main__":
    ...
    classname_to_id = {'shuangrenchuang': 1, 'bayi': 2, 'chaji': 3, 'chuwugui': 4, 'ertongchuang': 5, 'yigui': 6,
                       'buyishafa': 7, 'jiugui': 8, 'huwaideng': 9, 'diaodeng': 10, 'chugui': 11, 'shuzhuangtai': 12,
                       'zhuangshigui': 13, 'shuijingdeng': 14, 'weiyugui': 15, 'xiegui': 16, 'canzhuo': 17,
                       'xuanguangui': 18, 'pizhishafa': 19, 'shuzhuo': 20, 'dianshigui': 21, 'yuanchuang': 22,
                       'danrenchuang': 23, 'shugui': 24, 'chazhuo': 25, 'canzhuoyi': 26, 'batai': 27}

    work_root = "/home/user/qunosen/2_project/4_train/2_zhuchao/6_d2_final_train/2_train/4_train_2020_10_3/class27_set"
    ...
    train_json_path = "/data/1_qunosen/4_train_set/1_objetct_detection/class27_set/train.json"
    val_json_path = "/data/1_qunosen/4_train_set/1_objetct_detection/class27_set/val.json"
    train_images_dir = "/data/1_qunosen/4_train_set/1_objetct_detection/class27_set/images/train"
    val_images_dir = "/data/1_qunosen/4_train_set/1_objetct_detection/class27_set/images/val"

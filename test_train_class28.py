...
if __name__=="__main__":
    ...
    classname_to_id = {'shuangrenchuang': 1, 'bayi': 2, 'chaji': 3, 'diaodeng': 4, 'chuwugui': 5, 'ertongchuang': 6,
                       'buyishafa': 7, 'yigui': 8, 'chuangtougui': 9, 'jiugui': 10, 'huwaideng': 11, 'pizhishafa': 12,
                       'xuanguangui': 13, 'chugui': 14, 'shuijingdeng': 15, 'shuzhuangtai': 16, 'weiyugui': 17,
                       'shuzhuo': 18, 'xiegui': 19, 'canzhuo': 20, 'dianshigui': 21, 'zhuangshigui': 22, 'yuanchuang': 23,
                       'danrenchuang': 24, 'batai': 25, 'shugui': 26, 'chazhuo': 27, 'canzhuoyi': 28}


    work_root = "/home/user/qunosen/2_project/4_train/2_zhuchao/6_d2_final_train/2_train/4_train_2020_10_3/class28_set"
    # work_root = "/home/user/qunosen/2_project/4_train/2_zhuchao/6_d2_final_train/2_train/4_train_2020_10_3/class28_set/gen"
    ...
    train_json_path = "/data/1_qunosen/4_train_set/1_objetct_detection/class28_set/train.json"
    val_json_path = "/data/1_qunosen/4_train_set/1_objetct_detection/class28_set/val.json"
    train_images_dir = "/data/1_qunosen/4_train_set/1_objetct_detection/class28_set/images/train"
    val_images_dir = "/data/1_qunosen/4_train_set/1_objetct_detection/class28_set/images/val"

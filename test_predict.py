...
def image_predict(bgr_img):
    ...
    # v = Visualizer(bgr_img[:, :, ::-1], metadata=MetadataCatalog.get(regist_train_name), scale=0.9, instance_mode=ColorMode.IMAGE_BW)
    # v = v.draw_instance_predictions(outputs["instances"].to("cpu"))
    # predict_file = "/home/user/tmp/pycharm_project_310/1_detectron2/ImageDetectionAPI/d2_object_detection/test_out/2.png"
...
def test():
    ...
    # imgfile = "../demo.jpg"
    imgfile = '/data/1_qunosen/4_train_set/1_objetct_detection/mvp_class27_set/images/val/00c1a4e909b46665_9-3426.jpg'
...
pred_classes = [24, 24, 2, 15]

#pred_classes = [ i + 1 for i in pred_classes]
# objects = list(zip(map(ID_NAME_DICT.get,[ i + 1 for i in pred_classes])))
objects = list(zip(map(list(ID_NAME_DICT.values()),pred_classes)))

...
if __name__=="__main__":
    ...
    classname_to_id = {'shuangrenchuang': 1, 'danrenchuang': 2, 'bayi': 3, 'danyi': 4, 'bianji': 5, 'chuwugui': 6,
                       'ertongchuang': 7, 'buyishafa': 8, 'yigui': 9, 'dianshigui': 10, 'chuangtougui': 11,
                       'jiugui': 12, 'huwaideng': 13, 'pizhishafa': 14, 'xuanguangui': 15, 'canzhuoyi': 16,
                       'diaodeng': 17, 'shuijingdeng': 18, 'shuzhuangtai': 19, 'weiyugui': 20, 'shuzhuo': 21,
                       'chazhuo': 22, 'shafazuhe': 23, 'xiegui': 24, 'chugui': 25, 'canzhuo': 26, 'chaji': 27,
                       'zhuangshigui': 28, 'yuanchuang': 29, 'shugui': 30, 'batai': 31}


    work_root = "/home/user/qunosen/2_project/4_train/2_zhuchao/6_d2_final_train/2_train/5_train_2020_10_12/class31_set"
    ...
    train_json_path = "/data/1_qunosen/4_train_set/1_objetct_detection/class31_set/train.json"
    val_json_path = "/data/1_qunosen/4_train_set/1_objetct_detection/class31_set/val.json"
    train_images_dir = "/data/1_qunosen/4_train_set/1_objetct_detection/class31_set/images/train"
    val_images_dir = "/data/1_qunosen/4_train_set/1_objetct_detection/class31_set/images/val"
